...
def make_predictions(args):
    ...
    svpath = '/media/shengjie/disk1/Prediction/Deepv2d_eigen'
    np.random.seed(1234)
    ...
    with tf.Session() as sess:
        ...
        predictions = []
        for (images, intrinsics, test_frame) in db.test_set_iterator():
            ...
            gt = Image.open(os.path.join(semidensegtroot, test_frame.replace('/data', '')))
            gtw, gth = gt.size
